...
public class RuleData {
	...
	/**
	 * @return the ruleAlert
	 */
	public String getRuleAlert() {
		return ruleAlert;
	}
	/**
	 * @param ruleAlert the ruleAlert to set
	 */
	public void setRuleAlert(String ruleAlert) {
		this.ruleAlert = ruleAlert;
	}
	/**
	 * @return the ruleExpr
	 */
	...
	/**
	 * @param ruleExpr the ruleExpr to set
	 */
	...
	/**
	 * @param ruleSeverity the ruleSeverity to set
	 */
	public void setRuleSeverity(String ruleSeverity) {
		this.ruleSeverity = ruleSeverity;
	}
	/**
	 * @return the ruleChannel
	 */
	public String getRuleChannel() {
		return ruleChannel;
	}
	/**
	 * @param ruleChannel the ruleChannel to set
	 */
	...
	/**
	 * @return the ruleSummary
	 */
	public String getRuleSummary() {
		return ruleSummary;
	}
	/**
	 * @param ruleSummary the ruleSummary to set
	 */
