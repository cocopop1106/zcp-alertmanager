...
public class ChannelDtlVo {
	...
	/**
	 * @param email_smarthost
	 *            the email_smarthost to set
	 */
	...
	/**
	 * @param email_auth_username
	 *            the email_auth_username to set
	 */
	...
	/**
	 * @param email_auth_password
	 *            the email_auth_password to set
	 */
	...
	/**
	 * @param email_require_tls
	 *            the email_require_tls to set
	 */
	...
	/**
	 * @param email_send_resolved
	 *            the email_send_resolved to set
	 */
	...
	/**
	 * @param slack_send_resolved
	 *            the slack_send_resolved to set
	 */
	...
	/**
	 * @param hipchat_api_url
	 *            the hipchat_api_url to set
	 */
	...
	/**
	 * @param hipchat_room_id
	 *            the hipchat_room_id to set
	 */
	...
	/**
	 * @param hipchat_auth_token
	 *            the hipchat_auth_token to set
	 */
	...
	/**
	 * @param hipchat_notify
	 *            the hipchat_notify to set
	 */
	...
	/**
	 * @param hipchat_send_resolved
	 *            the hipchat_send_resolved to set
	 */
	...
	/**
	 * @param webhook_send_resolved
	 *            the webhook_send_resolved to set
	 */
